...
var StandardRenderer = function ( webglRenderer, teapots, dispParams ) {
	...
	grid.rotation.x = 90 * THREE.MathUtils.DEG2RAD;
	...
	sqGrid.rotation.y = 45 * THREE.MathUtils.DEG2RAD;
	...
	plane.rotation.y = 0 * THREE.MathUtils.DEG2RAD;

	plane.rotation.z = 45 * THREE.MathUtils.DEG2RAD;
	...
	sqGridBackRight.rotation.x = 90 * THREE.MathUtils.DEG2RAD;

	sqGridBackRight.rotation.z = 45 * THREE.MathUtils.DEG2RAD;
	...
	planeBackRight.rotation.x = 0 * THREE.MathUtils.DEG2RAD;

	planeBackRight.rotation.y = - 45 * THREE.MathUtils.DEG2RAD;

	planeBackRight.rotation.z = 0 * THREE.MathUtils.DEG2RAD;
	...
	sqGridBackLeft.rotation.x = 90 * THREE.MathUtils.DEG2RAD;

	sqGridBackLeft.rotation.z = - 45 * THREE.MathUtils.DEG2RAD;
	...
	planeBackLeft.rotation.x = 0 * THREE.MathUtils.DEG2RAD;

	planeBackLeft.rotation.y = 45 * THREE.MathUtils.DEG2RAD;

	planeBackLeft.rotation.z = 0 * THREE.MathUtils.DEG2RAD;
